  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>      
      ...
      <View style={styles.content}>        
        ...
        <Typography variant="body" align="center" color="textSecondary" style={{ marginBottom: 48, paddingHorizontal: 20 }}>Hold your WIC EBT card under the camera to scan the barcode</Typography>
...
const styles = StyleSheet.create({
  ...
  manualButtonText: { fontSize: 16, fontWeight: '400' },
  infoCard: { flexDirection: 'row', padding: 16, borderRadius: 16, marginBottom: 12, width: '100%', alignItems: 'flex-start', gap: 12 },
